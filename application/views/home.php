...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				...
				<div class="carousel-caption d-none d-md-block text-left">
					...
					<a class="btn btn-success page-scroll" href="#daftar"><i class="fa fa-fw fa-send-o"></i> Daftar Sekarang</a>
				</div>
			</div>
	...
	<section id="intro" class="bg-white py-4">
		...
		<div class="container">
			...
			<div class="row wow fadeInUp" data-wow-delay="100ms" data-wow-duration="700ms">
				<div class="col-lg-12">
					<h1 class="mb-4 text-center">Pengumuman</h1>
				</div>
				<div class="col-lg-7">
		...
		<div class="container">
			<div class="row wow fadeInUp" data-wow-delay="100ms" data-wow-duration="700ms">
				<div class="col-lg-12">
					...
					<img src="<?= base_url('assets/images/alurdaftar.png')  ?>" class="img-responsive img-thumbnail" alt="">
	...
	<section id="contact" class="bg-dark text-white py-5">
		<div class="container">
			<div class="row wow fadeInUp" data-wow-delay="100ms" data-wow-duration="700ms">
				<div class="col-md-12">
					<h1 class="text-white mb-3">Informasi Pendaftaran</h1>

					<h5 class="text-white mb-3">Untuk informasi lebih lanjut, hubungi Bagian Pendaftaran pada outlet kampus:</h5>
				</div>

				<div class="col-lg-8" id="map">
					<div class="table-responsive">
						<!-- Google Maps IFrame -->
						<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3965.658745470189!2d107.02256196413848!3d-6.3084854634914995!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e6991ebf737abaf%3A0xfd4eb3c3a45b4f28!2sRT.004%2FRW.012%2C%20Padurenan%2C%20Kec.%20Mustika%20Jaya%2C%20Kota%20Bks%2C%20Jawa%20Barat!5e0!3m2!1sid!2sid!4v1596548074692!5m2!1sid!2sid" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
						<!-- -->
					</div>
				</div>
				<div class="col-lg-4">
					<img src="<?php echo base_url('assets/images/FU.png'); ?>" width="100px" height="100px" class="img-circle" alt="Fhizyel University">
					<h3 class="text-white mt-3">Kontak</h3>
					<p><i class="fa fa-phone"></i> Telp.: <?php echo $site_phone; ?></p>
					<p><i class="fa fa-envelope-o"></i> Email: <?php echo $site_email; ?></p>
					<p><i class="fa fa-home"></i> Website: <a class="text-light" href="http://<?php echo $site_website; ?>"><?php echo $site_website; ?></a></p>
					<ul class="list-unstyled list-inline">
						...
						<li class="list-inline-item">
							<a class="text-danger" href="<?php echo $site_youtube; ?>"><i class="fa fa-linkedin fa-2x"></i></a>
						</li>
			...
			<div class="container my-auto mt-5">
				<div class="copyright text-center my-auto">
					<span>Copyright &copy; Fhizyel Nazareta 2020</span>
				</div>
			</div>
		</div>
	</section>
